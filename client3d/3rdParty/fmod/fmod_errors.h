...
#ifdef __GNUC__
static const char *FMOD_ErrorString(FMOD_RESULT errcode) __attribute__((unused)); // const keyword added by polyveg to make the compiler happy.
#endif

static const char *FMOD_ErrorString(FMOD_RESULT errcode) // const keyword added by polyveg to make the compiler happy.
{
    switch (errcode)
    {
