...
//	mCamera->setProjectionType(PT_ORTHOGRAPHIC);
	mCamera->setPosition(Vector3(0,CAMERA_ZOOM+150, CAMERA_ZOOM+150));
	mCamera->setNearClipDistance(CAMERA_ZOOM);
	mCamera->yaw(Radian(.45));
//	mCamera->lookAt(Vector3(0,150,0));
*/
	//mCamera->setPosition(Vector3(0,0,200));


//mCamera->setPosition(800,800 , 450);
//				mCamera->yaw(Radian(.45));
