...
ib:AddMsg("[INTRO] This quest is a mixture between kill and item quest: You have to kill defined mobs - instead of counting the kills you has a chance of x that you get an quest item from them.")
...
ib:AddMsg("[not-done-text] Come back if you have killed all!\n")
Q_List(q_obj_1, ib)
