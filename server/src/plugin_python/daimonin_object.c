...
static char *flag_names[NUM_FLAGS+1] = {
	"f_sleep", "f_confused", NULL, "f_scared", "f_is_blind","f_is_invisible" , "f_is_ethereal" ,
	"f_is_good", "f_no_pick", "f_walk_on", "f_no_pass",		/* 10 */
	"f_is_animated", NULL, "f_flying", "f_monster", "f_friendly", 	
	NULL /*is_removed*/,"f_been_applied", "f_auto_apply", "f_treasure", "f_is_neutral",	/* 20 */
	...
	"f_blocksview", "f_undead", NULL, "f_unaggressive",
	...
	"f_xrays", NULL, "f_is_floor", "f_lifesave", "f_is_magical", "f_alive",
	"f_stand_still", "f_random_move", "f_only_attack", "f_wiz",	/* 70 */
	"f_stealth", NULL, NULL, "f_cursed", "f_damned",
	...
	"f_use_fix_pos","f_unpaid","f_is_aged","f_make_invisible" , "f_make_ethereal","f_is_player",
	...
	"f_was_reflected", "f_is_missile","f_can_reflect_missile","f_can_reflect_spell","f_is_assassin",
	NULL /* internal flag: HAS_MOVED */, "f_no_save"
};
