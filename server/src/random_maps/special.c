    ...
    switch (hole_type)
    {
        case GLORY_HOLE:
          /* treasures */
          {
              ...
              write_parameters_to_string(buf, g_xsize, g_ysize, RP->wallstyle, RP->floorstyle, "none", "none", "onion",
                                         "wealth2", "none", RP->exitstyle, 0, 0, OPT_WALLS_ONLY, 0, 0, 1,
                                         RP->dungeon_level, RP->dungeon_level, RP->difficulty, RP->difficulty, -1, 1, 0,
                                         0, 0, 0);
        ...
        case ORC_ZONE:
          /* hole with orcs in it. */
          {
              ...
              g_xsize = RANDOM() % 3 + 4 + RP->difficulty / 4;
              g_ysize = RANDOM() % 3 + 4 + RP->difficulty / 4;
              write_parameters_to_string(buf, g_xsize, g_ysize, RP->wallstyle, RP->floorstyle, "orc", "none", "onion",
                                         "wealth2", "none", RP->exitstyle, 0, 0, OPT_WALLS_ONLY, 0, 0, 1,
                                         RP->dungeon_level, RP->dungeon_level, RP->difficulty, RP->difficulty, -1, 1, 0,
                                         0, 0, 0);
              FREE_AND_COPY_HASH(the_exit->slaying, "/!");
        ...
        case MINING_ZONE:
          /* hole with orcs in it. */
          {
              ...
              write_parameters_to_string(buf, g_xsize, g_ysize, RP->wallstyle, RP->floorstyle, "none", "none", "maze",
                                         "minerals2", "none", RP->exitstyle, 0, 0, OPT_WALLS_ONLY, 0, 0, 1,
                                         RP->dungeon_level, RP->dungeon_level, RP->difficulty, RP->difficulty, -1, 1, 0,
                                         0, 0, 0);
              FREE_AND_COPY_HASH(the_exit->slaying, "/!");
              FREE_AND_COPY_HASH(the_exit->msg, buf);
