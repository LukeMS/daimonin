...
/* 0 */
    { "stealing",           NULL, EXP_NONE, 0, 0, 0.1f,      DEX,     INT, NO_STAT_VAL },
    { "pick locks",         NULL, EXP_NONE, 0, 50, 1.5f,   DEX,     INT, NO_STAT_VAL },
...
/* 5 */
    ...
    { "alchemy",            NULL, EXP_NONE, 10, 1, 1.0f, 	INT, 	 WIS, 	  DEX },
    { "magic lore",         NULL, 2, 0, 0, 0.0f, 	NO_STAT_VAL, 	 NO_STAT_VAL,     NO_STAT_VAL },
    { "common literacy",    NULL, EXP_NONE, 10, 1, 1.0f, 	INT, 	 WIS, NO_STAT_VAL },
...
/* 10 */
    ...
    { "sense magic",        NULL, EXP_NONE, 10, 10, 1.0f, 	POW, 	 INT, NO_STAT_VAL },
    { "oratory",            NULL, EXP_NONE, 5, 1, 2.0f,      CHA,     INT, NO_STAT_VAL },
    { "singing",            NULL, EXP_NONE, 5, 1, 2.0f,      CHA,     INT, NO_STAT_VAL },
    { "sense curse",        NULL, EXP_NONE, 10, 10, 1.0f, 	WIS,     POW, NO_STAT_VAL },
/* 15 */
    { "find traps",         NULL, EXP_NONE, 0, 0, 0.0f,  NO_STAT_VAL, NO_STAT_VAL, NO_STAT_VAL },
    { "meditation",         NULL, EXP_NONE, 10, 0, 0.0f, WIS,      POW,     INT },
    { "punching",           NULL, EXP_NONE, 0, 0, 1.0f,      STR,      DEX, NO_STAT_VAL },
    { "flame touch", 	    NULL, EXP_NONE, 0, 0, 1.0f,      STR,      DEX,     INT }, 
...
/* 20 */
    ...
    { "inscription",        NULL, EXP_NONE, 0, 1, 5.0f,      POW,      INT,  NO_STAT_VAL },
