 ...
 */
#define ATNR_PHYSICAL       0 /* = impact. kind of basic damage */
#define ATNR_MAGIC          1
#define ATNR_FIRE           2
...
#define ATNR_HOLYWORD       21  /* extern name is 'purity' */
...
EXTERN char    *protection_save[NROFPROTECTIONS]    =
{
    "impact", "slash", "cleave", "pierce", "weapon_magic", "fire", "cold", "electricity", "poison", "acid", "magic",
    "mind", "body", "psionic", "force", "nether", "chaos", "death", "spiritual", "corruption"
};

EXTERN char    *protection_name[NROFPROTECTIONS]    =
{
    "impact", "slash", "cleave", "pierce", "weapon magic", "fire", "cold", "electricity", "poison", "acid", "magic",
    "mind", "body", "psionic", "force", "nether", "chaos", "death", "spiritual", "corruption"
};
...
EXTERN char    *resist_save[NROFATTACKS]            =
{
    "impact", "magic", "fire", "electricity", "cold", "confusion", "acid", "drain", "weaponmagic", "ghosthit", "poison",
    "slow", "paralyze", "time", "fear", "cancellation", "depletion", "death", "chaos", "counterspell", "godpower",
    "purity", "blind", "internal", "life_steal", "slash", "cleave", "pierce", "nether", "sonic", "demonic", "psionic"
};

/* Short description of names of the attacktypes */
EXTERN char    *attacktype_desc[NROFATTACKS]        =
{
    "impact", "magic", "fire", "electricity", "cold", "confusion", "acid", "drain", "weapon magic", "ghost hit",
    "poison", "slow", "paralyze", "time", "fear", "cancellation", "depletion", "death", "chaos", "counterspell",
    "god power", "purity", "blind", "internal", "life steal", "slash", "cleave", "pierce", "nether", "sonic", "demonic",
    "psionic"
};
...
EXTERN char    *resist_plus[NROFATTACKS]            =
{
    "resist impact", "resist magic", "resist fire", "resist electricity", "resist cold", "resist confusion",
    "resist acid", "resist drain", "resist weaponmagic", "resist ghosthit", "resist poison", "resist slow",
    "resist paralyze", "resist time", "resist fear", "resist cancellation", "resist depletion", "resist death",
    "resist chaos", "resist counterspell", "resist god power", "resist purity", "resist blind", "resist internal",
    "resist life steal", "resist slash", "resist cleave", "resist pierce", "resist nether", "resist sonic",
    "resist demonic", "resist psionic"
};
...
EXTERN char    *change_resist_msg[NROFATTACKS]      =
{
    "impact", "magic", "fire", "electricity", "cold", "confusion", "acid", "drain", "weapon magic", "ghosthit",
    "poison", "slow", "paralyze", "time", "fear", "cancellation", "depletion", "death", "chaos", "counterspell",
    "god power", "purity", "blind", "internal", "life steal", "slash", "cleave", "pierce", "nether", "sonic", "demonic",
    "psionic"
};
...
EXTERN int      resist_table[]                      =
{
    ...
    ATNR_CONFUSION, ATNR_ACID, ATNR_DRAIN, ATNR_GHOSTHIT, ATNR_POISON, ATNR_SLOW, ATNR_PARALYZE, ATNR_TIME, ATNR_FEAR,
    ATNR_SLASH, ATNR_DEPLETE, ATNR_CLEAVE, ATNR_SONIC, ATNR_PHYSICAL, ATNR_BLIND, ATNR_LIFE_STEALING, ATNR_PSIONIC,
    ATNR_NETHER, ATNR_PIERCE, ATNR_SLASH, ATNR_CLEAVE, ATNR_PIERCE, ATNR_PHYSICAL, ATNR_MAGIC, ATNR_FIRE,
    ATNR_ELECTRICITY, ATNR_COLD, ATNR_CONFUSION, ATNR_ACID, ATNR_DRAIN, ATNR_GHOSTHIT, ATNR_POISON, ATNR_SLOW,
    ATNR_PARALYZE, ATNR_TIME, ATNR_FEAR, ATNR_CANCELLATION, ATNR_DEPLETE, ATNR_COUNTERSPELL, ATNR_SONIC, ATNR_HOLYWORD,
    ATNR_BLIND, ATNR_LIFE_STEALING, ATNR_PSIONIC, ATNR_NETHER, ATNR_DEMONIC, ATNR_DEATH, ATNR_CHAOS, ATNR_GODPOWER,
    ATNR_WEAPONMAGIC
};
