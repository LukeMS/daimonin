...
extern char            *query_name_full(object *op, object *caller);
...
extern void             create_treasure_list(struct oblnk *t, object *op, int flag, int difficulty, int t_style,
                                             int a_chance, int tries, struct _change_arch *arch_change);
