...
extern int fix_generated_item(object *op, object *creator, int difficulty, int max_magic, int fix_magic, int chance_magic, int flags);
...
extern int  generate_artifact(object *op, int difficulty);
