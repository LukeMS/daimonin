    ...
    if(!strcmp(params,"name")) /* ban name */
    {
        if (sscanf(str, "%s %d", name_buf, &ticks) == 2)
        {
            ...
            if(name && name[0]!='\0')
            {
                ...
                /* This is horrible - replaced!!
                /* It is a conditional expression which does nothing
                /* apart from relying on its side-effect. */
