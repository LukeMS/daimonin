...
///
///================================================================================================
int DialogInterface::interface_cmd_head(_gui_interface_head *head, char *data, int *pos)
{
    /*
        char *buf, c;
...
///
///================================================================================================
int DialogInterface::interface_cmd_link(_gui_interface_link *head, char *data, int *pos)
{
    /*
        char *buf, c;
...
///================================================================================================
int DialogInterface::interface_cmd_who(_gui_interface_who *head, char *data, int *pos)
{
    /*
     char *buf, c;
...
///
///================================================================================================
int DialogInterface::interface_cmd_reward(_gui_interface_reward *head, char *data, int *pos)
{
    /*
        char *buf, c;
...
///
///================================================================================================
int DialogInterface::interface_cmd_message(_gui_interface_message *msg, char *data, int *pos)
{
    /*
        char *buf, c;
...
///
///================================================================================================
int DialogInterface::interface_cmd_xtended(_gui_interface_xtended *msg, char *data, int *pos)
{
    /*
     char *buf, c;
...
///
///================================================================================================
int DialogInterface::interface_cmd_icon(_gui_interface_icon *head, char *data, int *pos)
{
    /*
        char *buf, c;
...
///
///================================================================================================
int DialogInterface::interface_cmd_button(_gui_interface_button *head, char *data, int *pos)
{
    /*
        char *buf, c;
...
///================================================================================================
int DialogInterface::interface_cmd_textfield(_gui_interface_textfield *textfield, char *data, int *pos)
{
    /*
        char *buf, c;
...
void DialogInterface::reset_gui_interface(void)
{
    /*
        map_udate_flag = 2;
...
void DialogInterface::format_gui_interface(_gui_interface_struct *gui_int)
{
    /*
        int s;
...
///================================================================================================
void DialogInterface::load_gui_interface(int mode, char *data, int len, int pos)
{
    /*
...
///================================================================================================
void DialogInterface::gui_interface_send_command(int mode, char *cmd)
{
    /*
        char msg[1024];
...
///================================================================================================
int DialogInterface::get_interface_line(int *element, int *index, char **keyword, int x, int y, int mx, int my)
{
/*
...
///
///================================================================================================
int DialogInterface::precalc_interface_npc(void)
{
/*
    int yoff, i;
    yoff = 5;
...
///================================================================================================
void DialogInterface::show_interface_npc(int mark)
{
/*
    SDL_Rect    box;
...
///================================================================================================
/*
void DialogInterface::gui_interface_mouse(SDL_Event *e)
{
