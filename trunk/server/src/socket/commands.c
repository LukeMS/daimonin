...
CommArray_s Commands[] =
{
    ...
    {"run_stop",      command_run_stop,       0.0f},
...
{
    {"nod",     command_nod,     1.0f},
    {"bounce",  command_bounce,  1.0f},
    {"laugh",   command_laugh,   1.0f},
    {"puke",    command_puke,    1.0f},
    {"sigh",    command_sigh,    1.0f},
    {"cry",     command_cry,     1.0f},
    {"grin",    command_grin,    1.0f},
    {"blush",   command_blush,   1.0f},
    {"cough",   command_cough,   1.0f},
    {"gasp",    command_gasp,    1.0f},
    {"hiccup",  command_hiccup,  1.0f},
    {"shiver",  command_shiver,  1.0f},
    {"smirk",   command_smirk,   1.0f},
    {"snicker", command_snicker, 1.0f},
    {"spit",    command_spit,    1.0f},
    {"twiddle", command_twiddle, 1.0f},
    {"wink",    command_wink,    1.0f},
    {"bleed",   command_bleed,   1.0f},
    {"me",      command_me,      1.0f},
    {"dance",   command_dance,   1.0f},
    {"smile",   command_smile,   1.0f},
    {"giggle",  command_giggle,  1.0f},
    {"growl",   command_growl,   1.0f},
    {"sulk",    command_sulk,    1.0f},
    {"poke",    command_poke,    1.0f},
    {"bow",     command_bow,     1.0f},
    {"burp",    command_burp,    1.0f},
    {"flip",    command_flip,    1.0f},
    {"glare",   command_glare,   1.0f},
    {"lick",    command_lick,    1.0f},
    {"shrug",   command_shrug,   1.0f},
    {"snap",    command_snap,    1.0f},
    {"sniff",   command_sniff,   1.0f},
    {"strut",   command_strut,   1.0f},
    {"wave",    command_wave,    1.0f},
    {"yawn",    command_yawn,    1.0f},
    {"cringe",  command_cringe,  1.0f},
    {"kiss",    command_kiss,    1.0f},
    {"cackle",  command_cackle,  1.0f},
    {"shake",   command_shake,   1.0f},
    {"scream",  command_scream,  1.0f},
    {"hug",     command_hug,     1.0f},
    {"accuse",  command_accuse,  1.0f},
    {"clap",    command_clap,    1.0f},
    {"chuckle", command_chuckle, 1.0f},
    {"frown",   command_frown,   1.0f},
    {"groan",   command_groan,   1.0f},
    {"pout",    command_pout,    1.0f},
    {"slap",    command_slap,    1.0f},
    {"sneeze",  command_sneeze,  1.0f},
    {"snore",   command_snore,   1.0f},
    {"thank",   command_thank,   1.0f},
    {"whistle", command_whistle, 1.0f},
    {"beg",     command_beg,     1.0f},
    {"think",   command_think,   1.0f},
};
