...
typedef enum _protections {
    PROTECT_PHYSICAL, /* = impact: we use physical intern */
    PROTECT_SLASH,
    PROTECT_CLEAVE,
    PROTECT_PIERCE,
    ...
    NROFPROTECTIONS,	/* marker - must be last value */
}_protections;
 ...
 */
EXTERN char *resist_save[NROFATTACKS] = {
"impact", "magic", "fire", "electricity", "cold", "confusion", "acid",
"drain", "weaponmagic", "ghosthit", "poison", "slow", "paralyze",
"time", "fear", "cancellation", "depletion", "death", "chaos",
"counterspell", "godpower", "purity", "blind" , "internal", "life_steal",
"slash", "cleave", "pierce", "nether", "sonic", "demonic", "psionic"
};
...
"time", "fear", "cancellation", "depletion", "death", "chaos",
"counterspell", "god power", "purity", "blind" , "internal", "life steal",
"slash", "cleave", "pierce", "nether", "sonic", "demonic", "psionic"
};
...
EXTERN char *resist_plus[NROFATTACKS] = {
"resist impact", "resist magic", "resist fire", "resist electricity", "resist cold", 
"resist confusion", "resist acid", "resist drain", 
"resist weaponmagic", "resist ghosthit", "resist poison", "resist slow",
"resist paralyze", "resist time", "resist fear", 
"resist cancellation", "resist depletion", "resist death", "resist chaos",
"resist counterspell", "resist god power", "resist purity",
"resist blind" ,  "resist internal", "resist life steal",
"resist slash", "resist cleave", "resist pierce",
...
EXTERN char *change_resist_msg[NROFATTACKS] = {
"impact", "magic", "fire", "electricity", "cold", "confusion", "acid",
"drain", "weapon magic", "ghosthit", "poison", "slow", "paralyze",
"time", "fear", "cancellation", "depletion", "death", "chaos",
"counterspell", "god power", "purity", "blind", "internal",
"life steal", "slash", "cleave", "pierce", "nether", "sonic", "demonic",
"psionic"
