...
enum spellnrs {
  /* HERE STARTS THE DAIMONIN LIST */
	SP_FIRESTORM,
	SP_ICESTORM, SP_MINOR_HEAL, SP_CURE_POISON, SP_CURE_DISEASE,SP_STRENGTH,
	SP_IDENTIFY, SP_DETECT_MAGIC,SP_DETECT_CURSE,SP_REMOVE_CURSE, SP_REMOVE_DAMNATION,	
	SP_CAUSE_LIGHT,SP_CONFUSION,SP_BULLET, SP_GOLEM, SP_REMOVE_DEPLETION,
	SP_PROBE,


  /* ALL DOWN HERE ARE ARTIFACTS FROM CROSSFIRE */
  		SP_S_FIREBALL,		SP_M_FIREBALL,		/*0*/
  SP_L_FIREBALL,	
  ...
  SP_IMPROVED_INVIS,	SP_HOLY_WORD,				/*30*/
...
/* mlee's spells*/	
  ...
  SP_L_SNOWSTORM,		SP_CAUSE_EBOLA,		/*170*/
...
typedef enum SpellTypeFrom {
  spellNormal, spellWand, spellRod, spellHorn, spellScroll, spellPotion,spellNPC
} SpellTypeFrom;
