...
/* button.c */
extern void             push_button(object *op, object *pusher);
extern void             update_button(object *op, object *activator);
...
extern const char      *normalize_path_direct(const char *src, const char *dst, char *path);
...
extern mapstruct       *load_map(const char *filename, const char *src_name, int flags);
...
extern mapstruct       *ready_map_name(const char *name_path, const char *src_path, int flags);
