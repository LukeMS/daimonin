...
{
    /* 0 */
    { "stealing",           NULL, SKILLGROUP_MISC, 20, 0, 0.1f,      DEX,     INTELLIGENCE, NO_STAT_VAL },
    { "pick locks",         NULL, SKILLGROUP_MISC, 20, 50, 1.5f,   DEX,     INTELLIGENCE, NO_STAT_VAL },
    { "hide in shadows",    NULL, SKILLGROUP_MISC, 10, 10, 2.5f,   DEX,     CHA, NO_STAT_VAL },
    ...
    { "magic lore",         NULL, 2, 10, 0, 0.0f,    NO_STAT_VAL,     NO_STAT_VAL,     NO_STAT_VAL },
    { "common literacy",    NULL, SKILLGROUP_MISC, 10, 1, 1.0f,    INTELLIGENCE,    WIS, NO_STAT_VAL },
    { "bargaining",         NULL, SKILLGROUP_MISC, 10, 0, 0.0f,  NO_STAT_VAL, NO_STAT_VAL, NO_STAT_VAL },
    /* 10 */
    { "jumping",            NULL, SKILLGROUP_MISC, 10, 5, 2.5f,      NO_STAT_VAL,     NO_STAT_VAL, NO_STAT_VAL },
    ...
    /* 15 */
    { "find traps",         NULL, SKILLGROUP_MISC, 10, 0, 0.0f,  DEX, NO_STAT_VAL, NO_STAT_VAL },
    ...
    /* 20 */
    { "mountaineer",        NULL, SKILLGROUP_MISC, 10, 0, 0.0f,  NO_STAT_VAL, NO_STAT_VAL, NO_STAT_VAL },
    { "ranger lore",        NULL, 6, 0, 0, 0.0f,    NO_STAT_VAL,     NO_STAT_VAL, NO_STAT_VAL },
    { "inscription",        NULL, SKILLGROUP_MISC, 10, 1, 5.0f,      POW,      INTELLIGENCE,  NO_STAT_VAL },
    ...
    /* 25 */
    { "throwing",           NULL, SKILLGROUP_MISC, 0, 0, 1.0f,      DEX,      DEX, NO_STAT_VAL },
    { "wizardry spells",    NULL, SKILLGROUP_MISC, 0, 0, 0.0f,      POW,      INTELLIGENCE,       WIS },
    { "remove traps",       NULL, SKILLGROUP_MISC, 10, 1, 0.5f,    DEX,      INTELLIGENCE, NO_STAT_VAL },
    { "set traps",          NULL, SKILLGROUP_MISC, 30, 1, 0.5f,    INTELLIGENCE,      DEX, NO_STAT_VAL },
    { "magic devices",      NULL, SKILLGROUP_MISC, 0, 0, 1.0f,   POW, DEX, NO_STAT_VAL },
    /* 30 */
    ...
    { "levitation",         NULL, SKILLGROUP_MISC, 10, 0, 0.0f, NO_STAT_VAL, NO_STAT_VAL, NO_STAT_VAL },
    { "disarm traps",       NULL, SKILLGROUP_MISC, 10, 1, 0.5f,      DEX,      INTELLIGENCE,     INTELLIGENCE },
