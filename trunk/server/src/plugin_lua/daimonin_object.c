...
struct attribute_decl GameObject_attributes[] =
{
    ...
    {"resist_magic",          FIELDTYPE_SINT8,     offsetof(object, resist[ATNR_CHANNELLING]),  FIELDFLAG_PLAYER_READONLY, 0},
    ...
    {"attack_magic",          FIELDTYPE_SINT8,     offsetof(object, attack[ATNR_CHANNELLING]),  FIELDFLAG_PLAYER_READONLY, 0},
