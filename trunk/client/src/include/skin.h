...
typedef enum skin_sprite_id_t
{
    ...
    SKIN_SPRITE_ALPHA,
    SKIN_SPRITE_SLIDER_HBARGE,
    SKIN_SPRITE_SLIDER_HCANAL,
    SKIN_SPRITE_SLIDER_LEFT,
    SKIN_SPRITE_SLIDER_RIGHT,
    SKIN_SPRITE_SLIDER_HL_HBARGE,
    SKIN_SPRITE_SLIDER_HL_HCANAL,
    SKIN_SPRITE_SLIDER_HL_LEFT,
    SKIN_SPRITE_SLIDER_HL_RIGHT,
